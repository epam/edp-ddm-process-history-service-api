...
@Repository
public interface ProcessRepository extends PagingAndSortingRepository<BpmHistoryProcess, String> {

  List<BpmHistoryProcess> findAllByStartUserIdAndStateInAndSuperProcessInstanceIdIsNull(
      String startUserId, Set<String> stateIn, Pageable pageable);

  List<BpmHistoryProcess> findAllByProcessInstanceIdIn(Set<String> processInstanceIdIn);
